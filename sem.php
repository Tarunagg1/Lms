...
$sem1=$_REQUEST['sem'];
$query="update registration set sem='$sem1'where password='$pass1'";
...
<div class="login_wrapper">
    ...
    <section class="login_content">
        <form name="form1" action="" method="post">
            ...
            <div>
              <br><input type="text" name="sem" class="form-control" placeholder="enter new sem" required=""/>
           </div>
            ...
            <div>
                ...
                <input class="btn btn-default submit" type="submit" name="submit9" value="update sem">
