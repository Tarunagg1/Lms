...
$img=$_REQUEST['image'];
$query="update registration set image ='$img'where password='$pass1'";
...
<div class="login_wrapper">
    ...
    <section class="login_content">
        <form name="form1" action="" method="post">
            <h1>profile image update</h1>

            <div>
                <input type="password" name="password" class="form-control" placeholder="enter password" required=""/>
            </div>
            <div>
              <br><input type="file" name="image" class="form-control" placeholder="insert image" required=""/>
           </div>
            ...
            <div>
                ...
                <br><input class="btn btn-default submit" type="submit" name="submit9" value="update image">
