...
$query="update registration set contactno ='$phone'where password='$pass1'";
...
<div class="login_wrapper">
    ...
    <section class="login_content">
        <form name="form1" action="" method="post">
            <h1>contact num update</h1>

            <div>
                <input type="password" name="password" class="form-control" placeholder="enter password" required=""/>
            </div>
            <div>
              <br><input type="number" name="phonenum" class="form-control" placeholder="enter new number" required=""/>
           </div>
            ...
            <div>
                ...
                <br><input class="btn btn-default submit" type="submit" name="submit9" value="update number">
