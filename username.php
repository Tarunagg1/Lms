...
$query="update registration set username='$user'where password='$pass1'";
...
<div class="login_wrapper">
    ...
    <section class="login_content">
        <form name="form1" action="" method="post">
            ...
            <div>
              <br><input type="text" name="username" class="form-control" placeholder="enter new username" required=""/>
           </div>
            ...
            <div>
                ...
                <input class="btn btn-default submit" type="submit" name="submit9" value="update username">
